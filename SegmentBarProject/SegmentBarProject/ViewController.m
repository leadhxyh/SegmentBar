...
- (void)viewDidLoad {
    ...
    ContentView *cv = [[ContentView alloc] initWithFrame:CGRectMake(0, 44 + barView.frame.origin.y, self.view.frame.size.width, self.view.frame.size.height) andControllers:controllers];
